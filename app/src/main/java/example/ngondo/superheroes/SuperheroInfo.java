...
public class SuperheroInfo {
    ...
    * */
    ...
    public static final String[] HISTORY =
            {
                    "Superman is born Kal-El on the alien planet Krypton. His parents, Jor-El and " +
                            "Lara become aware of Krypton's impending destruction and Jor-El begins " +
                            "constructing a spacecraft that would carry Kal-El to Earth. During Krypton's last moments, Jor-El places young Kal-El in the spacecraft and launches it. Jor-El and Lara die as the spacecraft barely escapes Krypton's fate. The explosion transforms planetary debris into kryptonite, a radioactive substance that is lethal to superpowered (as by Earth's yellow sun) Kryptonians.\n" +
                            "\n" +
